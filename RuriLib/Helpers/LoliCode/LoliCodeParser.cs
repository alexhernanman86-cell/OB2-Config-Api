...
namespace RuriLib.Helpers.LoliCode
{
    ...
    public static class LoliCodeParser
    {
        ...
        /// <summary>
        /// Normalizes comparison strings to handle common aliases (e.g., "Equals" -> "EqualTo").
        /// </summary>
        private static string NormalizeComparisonString(string comparison)
        {
        ...
        private static StringKey ParseStringKey(ref string line)
        {
            ...
            var comparisonToken = LineParser.ParseToken(ref line);
            comparisonToken = NormalizeComparisonString(comparisonToken);
            key.Comparison = Enum.Parse<StrComparison>(comparisonToken);
        ...
        private static IntKey ParseIntKey(ref string line)
        {
            ...
            var comparisonToken = LineParser.ParseToken(ref line);
            comparisonToken = NormalizeComparisonString(comparisonToken);
            key.Comparison = Enum.Parse<NumComparison>(comparisonToken);
